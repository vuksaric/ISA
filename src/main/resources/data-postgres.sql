...
(false, '1990-05-03', 'administrator@gmail.com', 0, 'Pera', '$2a$10$2Wnb5XikAHuZH/zNOTI8guCilSoqZNOqJccQapXBd4N1pX9RCYFuO', false, '+38165299485', 'Peric', 3, 3),
(false, '1990-05-03', 'sava@gmail.com', 0, 'Sava', '$2a$10$2Wnb5XikAHuZH/zNOTI8guCilSoqZNOqJccQapXBd4N1pX9RCYFuO', false, '+38165299485', 'Marinkovic', 3, 3),
(false, '1990-05-03', 'mira@gmail.com', 1, 'Mira', '$2a$10$2Wnb5XikAHuZH/zNOTI8guCilSoqZNOqJccQapXBd4N1pX9RCYFuO', false, '+38165299485', 'Milosevic', 3, 3),
(false, '1990-05-03', 'suzana@gmail.com', 1, 'Suzana', '$2a$10$2Wnb5XikAHuZH/zNOTI8guCilSoqZNOqJccQapXBd4N1pX9RCYFuO', false, '+38165299485', 'Savic', 2, 2),
(false, '1990-05-03', 'jovana@gmail.com', 1, 'Jovana', '$2a$10$2Wnb5XikAHuZH/zNOTI8guCilSoqZNOqJccQapXBd4N1pX9RCYFuO', false, '+38165299485', 'Jelic', 5, 5);
...
INSERT INTO public.pharmacy_admin(pharmacy_id, user_id) VALUES
(1, 14),
(2, 15),
(3, 16);
...
('2021-06-07 14:00', '2021-06-29 13:30', null), --dermatolog 3 pharmacy 3
('2021-06-08 14:00', '2021-06-29 13:30', null), --dermatolog 3 pharmacy 3
('2021-06-09 14:00', '2021-06-29 13:30', null), --dermatolog 3 pharmacy 3
('2021-06-10 14:00', '2021-06-29 13:30', null), --dermatolog 3 pharmacy 3
('2021-05-10 14:00', '2021-05-10 13:30', null), --dermatolog 3 pharmacy 3
('2021-04-10 14:00', '2021-04-10 13:30', null), --dermatolog 3 pharmacy 3
('2021-03-10 14:00', '2021-03-10 13:30', null), --dermatolog 3 pharmacy 3
('2021-02-10 14:00', '2021-02-10 13:30', null), --dermatolog 3 pharmacy 3
('2021-01-10 14:00', '2021-01-10 13:30', null); --dermatolog 3 pharmacy 3
...
( false, 1, 10, 1, 1, null, 3, null, 1 ),
( false, 1, 11, 1, 1, null, 4, null, 1 ),
( false, 1, 12, 1, 1, null, 5, null, 1 ),
( false, 1, 13, 1, 1, null, 6, null, 1 );
...
('diagnosis', false, false, 1700, 10, 1, 1, 1, null, 3, null, 1),
('diagnosis', false, false, 1700, 11, 1, 1, 1, null, 4, null, 1),
('diagnosis', false, false, 1700, 12, 1, 1, 1, null, 5, null, 1),
('diagnosis', false, false, 1700, 13, 1, 1, 1, null, 6, null, 1),
('diagnosis', true, false, 1700, 14, 4, 1, 1, null, 109, 1, null),
('diagnosis', true, false, 1700, 15, 4, 1, 1, null, 110, 1, null),
('diagnosis', true, false, 1700, 15, 4, 1, 1, null, 111, 1, null),
('diagnosis', true, false, 1700, 16, 4, 1, 1, null, 112, 1, null),
('diagnosis', true, false, 1700, 17, 4, 1, 1, null, 113, 1, null),
('diagnosis', true, false, 1700, 18, 3, 1, 1, null, 114, 1, null),
('diagnosis', true, false, 1700, 14, 3, 1, 1, null, 115, 1, null),
('diagnosis', true, false, 1700, 15, 3, 1, 1, null, 116, 1, null),
('diagnosis', true, false, 1700, 16, 3, 1, 1, null, 117, 1, null),
('diagnosis', true, false, 1700, 17, 3, 1, 1, null, 118, 1, null);
...
INSERT INTO public.bill(date, price, medicine_id, pharmacy_id) VALUES
 ('2021-06-01 06:30:30', 120, 1, 1),
 ('2021-06-02 06:30:30', 150, 2, 1),
 ('2021-06-02 06:30:30', 130, 3, 1),
 ('2021-06-01 06:30:30', 110, 1, 1),
 ('2021-06-03 06:30:30', 190, 2, 1),
 ('2021-06-04 06:30:30', 170, 3, 1),
 ('2021-06-02 06:30:30', 130, 3, 1),
 ('2021-03-01 06:30:30', 110, 1, 1),
 ('2021-03-03 06:30:30', 190, 2, 1),
 ('2021-04-04 06:30:30', 170, 3, 1),
 ('2021-04-02 06:30:30', 130, 3, 1),
 ('2021-04-01 06:30:30', 210, 1, 1),
 ('2021-05-03 06:30:30', 590, 2, 1),
 ('2021-05-04 06:30:30', 1070, 3, 1),
 ('2021-01-04 06:30:30', 370, 3, 1),
 ('2021-02-04 06:30:30', 570, 3, 1),
 ('2021-01-04 06:30:30', 1700, 3, 1),
 ('2021-02-04 06:30:30', 20, 3, 1),
 ('2021-03-04 06:30:30', 10, 3, 1),
 ('2021-04-04 06:30:30', 120, 3, 1),
 ('2021-05-05 06:30:30', 200, 4, 1);

INSERT INTO public.order_list(admin_id, due_date, pharmacy_id, status, medicine_id)VALUES
(1, '2021-06-19 06:30:30',1, 0, 1),
(1, '2021-06-18 06:30:30',1, 1, 2),
(1, '2021-06-17 06:30:30',1, 1, 1),
(1, '2021-06-16 06:30:30',1, 0, 2);

INSERT INTO public.supplier(user_id) VALUES
 (18);

insert into public.offer(due_date,price,supplier_id,order_list_id) values
('2021-06-25 06:30:30',150.0,1,1),
('2021-06-26 06:30:30',140.0,1,1),
('2021-06-26 06:30:30',140.0,1,2),
('2021-06-26 06:30:30',140.0,1,2),
('2021-06-26 06:30:30',140.0,1,3);
...
(1,'2021-06-25 06:30:30','2021-06-30 06:30:30',7,1),
(1,'2021-07-25 06:30:30','2021-07-27 06:30:30',8,1),
(1,'2021-06-30 06:30:30','2021-07-01 06:30:30',10,0),
(1,'2021-06-25 06:30:30','2021-06-26 06:30:30',11,0);
